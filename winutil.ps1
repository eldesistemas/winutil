...
Function Invoke-WPFFormVariables {
  ...
  Write-Host ""
  Write-Host "DDDDDDDDDDDDD   CCCCCCCCCCCCC"
  Write-Host "D::::::::::::DDDCC:::::::::::::::C"
  Write-Host "D:::::::::::::::DCC:::::::::::::::C"
  Write-Host "DDD:::::DDDDD:::::DCC:::::CCCCCCCC::::C"
  Write-Host "  D:::::D    D:::::DC:::::C       CCCCCC"
  Write-Host "  D:::::D     D:::::DC:::::C"
  Write-Host "  D:::::D     D:::::DC:::::C"
  Write-Host "  D:::::D     D:::::DC:::::C"
  Write-Host "  D:::::D     D:::::DC:::::C"
  Write-Host "  D:::::D     D:::::DC:::::C"
  Write-Host "  D:::::D     D:::::DC:::::C"
  Write-Host "  D:::::D    D:::::D C:::::C       CCCCCC"
  Write-Host "DDD:::::DDDDD:::::D  CC:::::CCCCCCCC::::C"
  Write-Host "D:::::::::::::::D    CC:::::::::::::::C"
  Write-Host "D::::::::::::DDD      CC:::::::::::::::C"
  Write-Host "DDDDDDDDDDDDD           CCCCCCCCCCCCC"
  Write-Host ""
  Write-Host "====Datacenter Tech====="
...
$sync.configs.applications = '{
  ...
  "WPFInstalljava": {
    ...
    "choco": "javaruntime",
    "content": "Java JRE",
    "description": "Java Runtime Enviroment",
    "link": "https://www.java.com/es/download/ie_manual.jsp",
  ...
  "WPFInstallmicrosoft365": {
    ...
    "description": "Paqueteria office 365",
    "link": "https://www.microsoft.com/es-mx/microsoft-365/business/",
    "winget": "Microsoft.Office"
  },
  "WPFInstallforticlient": {
    "category": "Pro Tools",
    "choco": "forticlientvpn",
    "content": "Forticlient",
    "description": "VPN empresarial",
    "link": "https://www.fortinet.com/lat/support/product-downloads",
    "winget": "Fortinet.FortiClientVPN"
  },
  "WPFInstallopera": {
    "category": "Browsers",
    "choco": "opera",
    "content": "Opera",
    "description": "Test whit a Opera",
            ...
            <TabItem Header="Install" Visibility="Collapsed" Name="WPFTab1">
                <Grid Background="Transparent" >
                    ...
                    <StackPanel Background="{MainBackgroundColor}" Orientation="Horizontal" Grid.Row="0" HorizontalAlignment="Left" VerticalAlignment="Top" Grid.Column="0" Grid.ColumnSpan="3" Margin="5">
                        <Button Name="WPFinstall" Content=" Instalar/Actualizar Seleccionados" Margin="2" />
                        <Button Name="WPFGetInstalled" Content=" Obtener instalador" Margin="2"/>
                        <Button Name="WPFclearWinget" Content=" Limpiar seleccion" Margin="2"/>
                    </StackPanel>
                    ...
                    <ScrollViewer x:Name="scrollViewer" Grid.Row="1" Grid.Column="0" Padding="-1" VerticalScrollBarVisibility="Auto" HorizontalScrollBarVisibility="Auto"
                        ...
                        <Border Grid.Row="1" Grid.Column="0">
                            ...
                            <Label Name="WPFLabelBrowsers" Content="Navegadores" FontSize="{FontSizeHeading}" FontFamily="{HeaderFontFamily}"/>
                            ...
                            <Label Name="WPFLabelCommunications" Content="Comunicaciones" FontSize="{FontSizeHeading}" FontFamily="{HeaderFontFamily}"/>
                            <StackPanel Orientation="Horizontal">
                            ...
                            <StackPanel Orientation="Horizontal">
                                <CheckBox Name="WPFInstallforticlient" Content="Forticlient" ToolTip="VPN Empresarial." Margin="0,0,2,0"/>
                                <TextBlock Name="WPFInstallforticlientLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://www.fortinet.com/lat/support/product-downloads"/>
                            </StackPanel>

                            <Label Name="WPFLabelDevelopment" Content="Desarrollo" FontSize="{FontSizeHeading}" FontFamily="{HeaderFontFamily}"/>
                            <StackPanel Orientation="Horizontal">
                                <CheckBox Name="WPFInstalljava" Content="Java RE" ToolTip="Java Runtime Enviroment." Margin="0,0,2,0"/>
                                <TextBlock Name="WPFInstalljavaLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://www.java.com/es/download/ie_manual.jsp"/>
                            </StackPanel>
                            <StackPanel Orientation="Horizontal">
                    ...
                    <Border Grid.Row="1" Grid.Column="1">
                        <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True">
                            ...
                            <Label Name="WPFLabelDocument" Content="Documentos" FontSize="{FontSizeHeading}" FontFamily="{HeaderFontFamily}"/>
                            ...
                            <StackPanel Orientation="Horizontal">
                                <CheckBox Name="WPFInstallmicrosoft365" Content="Microsoft 365" ToolTip="Office365." Margin="0,0,2,0"/>
                                <TextBlock Name="WPFInstallmicrosoft365Link" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://www.microsoft.com"/>
                            </StackPanel>
                            <StackPanel Orientation="Horizontal">
                    ...
                    <Border Grid.Row="1" Grid.Column="3">
                        <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True">
                            ...
                            <Label Name="WPFLabelUtilities" Content="Utilidades" FontSize="{FontSizeHeading}" FontFamily="{HeaderFontFamily}"/>
